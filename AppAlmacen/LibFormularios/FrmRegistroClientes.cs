...
{
    public partial class FrmRegistroClientes : LibFormularios.FrmPadre
    {
        public FrmRegistroClientes()
        {
            InitializeComponent();
            IniciarEntidad(new cCliente());//Inicializa entidad apuntando cEntidad
        }        
        //Establecer los valores que iran a la tabla
        public override string[] AsignarValoresAtributos()
        {
            return new string[] { TxtCodCliente.Text, TxtNombre.Text, TxtDireccion.Text, 
        ...
        {
            if (TxtCodCliente.Text.Trim() != "" && TxtNombre.Text.Trim() != "")
                return true;
            else
                return false;
        }
